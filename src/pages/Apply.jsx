    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-6 text-center">
        ...
        <p className="mt-3 max-w-md text-neutral-400">
          Something&apos;s misconfigured on our end. Please check back shortly, or reach out to us
          directly.
        </p>
      </div>
    )
    ...
    <div className="min-h-screen flex flex-col items-center px-6 py-12">
      ...
      <div className="mt-10 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-5">
          <div>
            <label htmlFor="applicant_name" className="block text-sm text-neutral-300">
              Full name
            </label>
            <input
              id="applicant_name"
          ...
          <div>
            <label htmlFor="applicant_email" className="block text-sm text-neutral-300">
              Email
            </label>
            <input
              id="applicant_email"
          ...
          <div>
            <label htmlFor="applicant_phone" className="block text-sm text-neutral-300">
              Phone (optional)
            </label>
            <input
              id="applicant_phone"
          ...
          <div>
            <label htmlFor="desired_move_in" className="block text-sm text-neutral-300">
